...
<style>
    /* Estilos rápidos para tus clases de estado correcto/error */
...
(function() {
            ...
            fetch(`/api/consultar-dni/${valorDni}`)
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        // Sincronizamos con el estado de Filament/Livewire inmediatamente
                        @this.set('data.nombre', data.nombre);
                        @this.set('data.dni', valorDni);
    ...
    celularInput.addEventListener("input", function () {
        ...
        if (celularValido) {
            ...
            @this.set('data.celular', valorCelular); // Sincroniza celular con el backend
            verificarRequisitosParaIA(); 
        } else {
            ...
            video.addEventListener('play', () => {
                ...
                detectorInterval = setInterval(async () => {
                    ...
                    if (detection) {
                        ...
                        @this.set('data.face_vector', descriptorRegistrado);
